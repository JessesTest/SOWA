...
public class BillingBlobService
{
    ...
    {
        context.CloseFiles();
        await SendFileToStorage(context.BillingSummaryFile, "SW_Billing_Summary.txt", true);
        await SendFileToStorage(context.BillingExceptionFile, "SW_Billing_Err_Rpt.txt", false);
    }
